...
echo -e "${CYAN}│${YELLOW} Engine: ${BLUE}XeLaTeX${WHITE} with ${PURPLE}Inter${WHITE} font family                              ${CYAN}│${NC}"
echo -e "${CYAN}│${YELLOW} Features: ${GRAY}Auto cleanup of auxiliary files after successful build    ${CYAN}│${NC}"
echo -e "${CYAN}│                                                                     │${NC}"
